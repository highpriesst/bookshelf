...
const Footer = () => {
  return (
    <footer className="absolute bottom-0 p-4 bg-gray-200 mt-5 w-full sm:px-4 py-2.5 dark:bg-gray-800 overflow-hidden">
      <div>
        <nav className="bg-gray-200 border-gray-200 px-2 sm:px-4 dark:bg-gray-800">
          <div className="container flex flex-wrap justify-between items-cente mx-auto">
            ...
            {/* Make this page a little blogish page about yourself */}
